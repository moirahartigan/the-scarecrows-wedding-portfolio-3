...
def welcome_msg():
    ...
    print("#            __________        At Diddly Squat Farm                               #")
    print("#           |          |                                                          #")
    print("#           |          |                                                          #")
    print("#  _________|__________|_________               | *\_/* |__________               #")
    print("#      |   ______________   |                 | |__/-\__|_______   |              #")                                
    print("#      |  |              |  |                 |  |              |  |              #")
    print("#      |  |    0     0   |  |                 |  |    0    0    |  |              #")
    print("#      |  |      -       |  |                 |  |       -      |  |              #")
    print("#      |  |    \____/    |  |                 |  |     \___/    |  |              #")
    print("#      |  |              |  |                 |  |              |  |              #")
    print("#      |  |_____|\_/|____|  |                 |  |______________|  |              #")
    print("#      |________|/ \|_______|                 |________*****_______|              #")
    print("# _\_______|_____________|________/_   _\_______|____________|__________/_        #")
    print("#  /                              \     /                               \         #")
    print("###################################################################################")
    print("")
